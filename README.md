...
- [x] 第 11 章已有普通 CNN、Inception 与 ResNet 的 MNIST 架构对比实验。
- [ ] 第 12–13 章学习笔记与实验代码待继续补充。
...
| [第 11 章](./Chapter11_AdvancedCNN/) | 高级卷积神经网络（CNN） | [观看](https://www.bilibili.com/video/BV1Y7411d7Ys?p=11) | [课件](./Chapter11_AdvancedCNN/Lecture_11_Advanced_CNN.pdf) · [章节笔记](./Chapter11_AdvancedCNN/README.md) · [三种 CNN 架构实测](./Chapter11_AdvancedCNN/MNIST_Three_CNN_Architectures.ipynb) |
